...
My interest in research began with my undergraduate thesis in **computer vision and image processing**, where I first learned to translate theoretical ideas into practical solutions. This curiosity deepened at Samsung Research, where I contributed to multiple DOI and patent efforts for wearable systems. Most notably, **I served as the lead inventor of a boot-time optimization technique for WearOS devices, introducing a parallel pre-loading method that improved startup performance by 15%**. These experiences strengthened my ability to identify bottlenecks, design innovative system-level solutions and pursue research that delivers real-world impact. **I am eager to explore research domains where I can apply my skills and experience to drive meaningful advancements and contribute to cutting-edge innovations.**
